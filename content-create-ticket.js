...
function messageListener(message) {
	...
	if (message.issueData.id) {
		$form.Subject.value=`Issue #${message.issueData.id}`
	}
	if (message.issueData.reportedByUsernames) {
		$form.FromCustomer.value=message.issueData.reportedByUsernames[0]
	}
